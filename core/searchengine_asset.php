...
if ($nbassetkeywords==2)
{
	...
	$where="
		(
			...
			tassets.ip LIKE '%$assetkeywords_search[0]%' OR 
			tassets.ip2 LIKE '%$assetkeywords_search[0]%' OR 
			...
			tassets.ip LIKE '%$assetkeywords_search[1]%' OR 
			tassets.ip2 LIKE '%$assetkeywords_search[1]%' OR 
...
else if ($nbassetkeywords==3)
{
	...
	$where="
		(
			...
			tassets.ip LIKE '%$assetkeywords_search[2]%' OR 
			tassets.ip2 LIKE '%$assetkeywords_search[2]%' OR 
