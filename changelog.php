...
- LDAP: Synchronisation des groupe LDAP de service ou d'agence<br />
...
- Ticket: Lors de la création d'un nouveau ticket le bouton impression est déactivé car aucune donnée n'est encore enregistrée (./ticket.php) <br />
