...
if (!is_writable('./core/ticket.php') || !is_writable('./index.php') || !is_writable('./admin/parameters.php') || !is_writable('./download/readme.txt'))
{
	...
	<div class="alert alert-warning">
		...
		'.T_('Les fichiers serveur ne sont pas accessible en écriture, les installations automatique ou semi-automatique ne fonctionneront pas. <i>(Linux: chmod 777 -R /var/www/html/gestsup/*)</i>').'
		<br>
	</div>
	';
}
...
//get current channel 
$query=$db->query("SELECT update_channel FROM tparameters");
$update_channel= $query->fetch();
