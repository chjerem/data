									...
									<div class="widget-body">
										...
										if ($rparameters['user_register']==1)
										{
    										...
    										<div class="toolbar clearfix">
    											...
    											<div>
    												<a href="#" class="user-signup-link" data-toggle="modal" data-target="#forgot_password">
      ...
      <div class="modal-content">
        ...
        $password = chaine_aleatoire(10);
          //if "email" variable is filled out, send email
            ...
            //password conversion
            $salt = substr(md5(uniqid(rand(), true)), 0, 5); // Generate a random key
            //$newpassword=md5($salt . md5('jenoublieraiplusmonmotdepasse')); // store in md5, md5 password + salt
             $newpassword=md5($salt . md5($password)); // store in md5, md5 password + salt
            //update password
			$db->exec("UPDATE tusers SET password='$newpassword', salt='$salt',`chgpwd` = '1'  WHERE id LIKE '$userId'");
                
            //Email information
            $email = $_REQUEST['email'];
            $subject = "Réinitialisation mot de passe DATA";
            $comment = "Bonjour ".$ruser['firstname'].",\n\nVotre mot de passe a ete reinitialisé.\nVous pouvez vous connecter a DATA avec vos login et mot de passe suivant: \n   - Login : ".$ruser["login"]."\n   - Mot de passe : ".$password."\n   - URL : http://10.198.134.33:84/Data/index.php\n\nUne fois connecté une pop-up vous demandera de modifier votre mot de passe. \n\nCordialement, \n\nL'équipe DATA\n\n\nlien vers la documentation : http://10.198.134.33:84/doc/notice.pdf" ;

            //send email
            mail($email, utf8_decode($subject), utf8_decode($comment), "From: ecssfrance.webanalyse@orange.com");
            }
          ?>
 ...
 <form method="post">
  Email: <input name="email" type="text" /><br />
        ...
        <div class="modal-footer">
            <input type="submit" class="btn btn-default" value="Validé">
