...
if($_GET['tab']=='asset')
{
	...
	$label_type=T_('Tickets');
	$label_state1=T_('ouverts');
	$label_state2=T_('fermés');
	$subtitle='<u>'.T_('Total').' '.$label_state1.':</u> '.$count.' / <u>'.T_('Total').' '.$label_state2.':</u> '.$count2.'  / <u>'.T_('Total en cours').':</u> '.$count3.' / <u>'.T_('Total depuis le début').':</u> '.$count4;
